...
class CompileStyleSheet():
    ...
    def applyCompiledSass(self, generateIcons: bool = True):
        ...
        qcss_folder = get_resource_path('Qss/scss')
        css_folder = get_resource_path('generated-files/css/')
        main_sass_path = get_resource_path('Qss/scss/main.scss')
        styles_sass_path = get_resource_path('Qss/scss/_styles.scss')
        css_path = get_resource_path('generated-files/css/main.css')
        default_scss_path = get_resource_path('Qss/scss/defaultStyle.scss')
