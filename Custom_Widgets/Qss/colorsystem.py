...
class CreateColorVariable():
    ...
    def CreateVariables(self):
        ...
        QDir.addSearchPath('theme-icons', os.path.join(os.getcwd(), get_resource_path('Qss/icons/')))
        ...
        scss_folder = os.path.abspath(os.path.join(os.getcwd(), get_resource_path('Qss/scss')))
        if not os.path.exists(scss_folder):
            os.makedirs(scss_folder)

        scss_path = os.path.abspath(os.path.join(scss_folder, get_resource_path('_variables.scss')))
        f = open(scss_path, 'w')
        print(f"""
        //===================================================//
