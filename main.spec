...
a = Analysis(
    ...
    datas=[ ('json-styles/style.json', 'json-styles'),
        ...
        ('tagColor.json','.'),
        ('translations','.'),
        ('translations/translations_en.qm','translations'),
        ('translations/translations_pl.qm','translations'),
        ('translations/gb.svg','translations'),
        ('translations/pl.svg','translations'),
        ...
        ('Qss/icons/FFFFFF/feather/facebook.png','Qss/icons/FFFFFF/feather/'),
        ('Qss/icons/FFFFFF/feather/linkedin.png','Qss/icons/FFFFFF/feather/'),
        ('Qss/icons/FFFFFF/font_awesome/solid/rss.png','Qss/icons/FFFFFF/font_awesome/solid/'),
        ('Qss/scss/*', 'Qss/scss'),
        *pyvis_datas],
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=['PyQt5', 'PySide2', 'PyQt6','jupyterlab','notebook','jedi','spinx',],
    noarchive=False,
    optimize=0,
)
...
exe = EXE(
    ...
    icon = 'C:\\Users\\firenet\\FirenetViewer_email_view\\FirenetViewer\\miniLogo.ico'
)
