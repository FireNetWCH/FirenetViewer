...
a = Analysis(
    ...
    datas=[
        ...
        ('Qss/icons/black/*', 'Qss/icons/black'),
        ('Qss/icons/black/feather/*', 'Qss/icons/black/feather'),
        ('Qss/icons/black/font_awesome/brands/*', 'Qss/icons/black/font_awesome/brands'),
        ('Qss/icons/black/font_awesome/regular/*', 'Qss/icons/black/font_awesome/regular'),
        ('Qss/icons/black/font_awesome/solid/*', 'Qss/icons/black/font_awesome/solid'),
        ('Qss/icons/black/material_design/*', 'Qss/icons/black/material_design'),
        ('Qss/icons/FFFFFF/*', 'Qss/icons/FFFFFF'),
        ('Qss/icons/FFFFFF/feather/*', 'Qss/icons/FFFFFF/feather'),
        ('Qss/icons/FFFFFF/font_awesome/brands/*', 'Qss/icons/FFFFFF/font_awesome/brands'),
        ('Qss/icons/FFFFFF/font_awesome/regular/*', 'Qss/icons/FFFFFF/font_awesome/regular'),
        ('Qss/icons/FFFFFF/font_awesome/solid/*', 'Qss/icons/FFFFFF/font_awesome/solid'),
        ('Qss/icons/FFFFFF/material_design/*', 'Qss/icons/FFFFFF/material_design'),
        ('Qss/icons/icons/*', 'Qss/icons/icons'),
        ('Qss/icons/icons/feather/*', 'Qss/icons/icons/feather'),
